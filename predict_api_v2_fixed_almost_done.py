...
<nav>
  <div class="logo">🤟 Sign-Bridge AI</div>
  <div class="nav-r">
...
<div class="hero">
  ...
  <div class="title"><span class="w1">Sign</span><span class="w2">Bridge</span> <span class="w3">AI</span></div>
  <p class="sub">American Sign Language → Text → Speech · Multilingual Support<br/>MobileNetV2 · MediaPipe · WebSocket · Browser Camera · Cloud Ready ☁️</p>
  <div class="pills">
    <div class="pill pl1">MobileNetV2</div>
    <div class="pill pl2">MediaPipe Hands</div>
    <div class="pill pl3">Zero Lag WebSocket</div>
...
<footer><div class="fm">Made with <span class="heart">❤️</span> by <span class="name">Aksh Bhimani</span> &nbsp;·&nbsp; Sign-Bridge AI &nbsp;·&nbsp; Cloud Edition 2025</div></footer>
</div>
...
<div class="modal-bg" id="modal">
 <div class="modal">
  <div class="modal-top">
   <div><div class="mt">🤟 Sign-Bridge AI</div><div class="ms">Cloud-Ready Edition — Browser Camera + gTTS</div></div>
...
<section class="model-info">
  <div class="mi-header">
    ...
    <h2 class="section-title">How Sign-Bridge AI Works</h2>
